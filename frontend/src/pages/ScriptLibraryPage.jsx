    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        ...
        <p style={{ fontSize: '0.9375rem', color: 'var(--text3)', marginTop: 4 }}>
          Upload past scripts to train your voice and language bible. KP reads these when generating new episodes.
        </p>
      </div>
        ...
        <>
          ...
          >
            ...
            <div style={{ fontSize: '0.875rem', color: 'var(--text3)' }}>
              .txt, .md, .fountain — each file becomes a reference for KP
            </div>
          </div>
