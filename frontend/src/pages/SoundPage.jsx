      ...
      {loading ? (
        ...
        <div className="border border-dashed border-[#1a1a1a] rounded-lg p-12 text-center space-y-3">
          ...
          <div className="text-xs text-[#333] max-w-xs mx-auto leading-relaxed">
            Upload your music beds, stings, transitions, and atmospheres. KB will select specific files and place them at timecodes in every episode.
          </div>
        </div>
      ) : (
        <div className="space-y-2">
      ...
      {assets.length > 0 && (
        <div className="border border-[#1a1a1a] rounded-lg p-5 space-y-4">
          <div>
            ...
            <div className="text-xs text-[#444] mt-1">KB selects from your library and places files at exact timecodes. Export as audio EDL for DaVinci.</div>
          </div>
