        ...
        {step < CONTENT.length ? (
          ...
          <div className="space-y-6 text-center">
            <div>
              ...
              <p className="text-sm text-[#555] mt-2">WhispaCuts will ingest competitor content and set up your workspace. This takes a minute.</p>
            </div>
            ...
            <button onClick={finish} disabled={saving}
              ...
              {saving ? 'Setting up your workspace...' : 'Enter WhispaCuts'}
            </button>
          </div>
        )}
      </div>
